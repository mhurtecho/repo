...
public class ProductServiceTest extends JerseyTest {
	...
	protected Application configure() {
		return new ResourceConfig(ProductServiceWrapper.class);
	}
...
class ProductServiceWrapper extends ProductService {

	public ProductServiceWrapper() {
		super();

		productServiceDao = new ProductServiceDaoWrapper();
	}
...
class ProductServiceDaoWrapper extends ProductServiceDao {
	...
	public String getProduct(String id) {
		return productDao.get(id).toString();
	}
